...
@section('title', 'Data Pembelian: Belum Dikirim')
...
<div class="content">
	<div class="page-inner">
		<div class="page-header">
			<h4 class="page-title">Data Pembelian: Belum Dikirim</h4>
				...
				<div class="card">
					<div class="card-header">
						<div class="d-flex align-items-center">
							<h4 class="card-title">Data Pembelian: Belum Dikirim</h4>
						</div>
					</div>
					<div class="card-body">
									...
									<tr>
										...
										<td>
											<div class="form-button-action">
												<a href="/admin/pembelian/send/{{ $data->id_pembelian }}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Kirim pesanan">
			...
			$.ajax({
				...
				success: function(response){
					if(response == "Berhasil menghapus data."){
						alert(response);
						window.location.href = '/admin/pembelian/belum-dikirim';
					}
					else{
						alert(response);
					}
