...
@section('title', 'Data Pembelian: Sukses')
...
<div class="content">
	<div class="page-inner">
		<div class="page-header">
			<h4 class="page-title">Data Pembelian: Sukses</h4>
				...
				<div class="card">
					<div class="card-header">
						<div class="d-flex align-items-center">
							<h4 class="card-title">Data Pembelian: Sukses</h4>
						</div>
					</div>
					<div class="card-body">
									...
									<tr>
										...
										<td>
											<div class="form-button-action">
												<a data-toggle="tooltip" title="" class="btn btn-link btn-success" data-original-title="Sukses" onclick="event.preventDefault();" disabled style="cursor: not-allowed;">
