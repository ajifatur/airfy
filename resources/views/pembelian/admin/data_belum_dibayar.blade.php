...
@section('title', 'Data Pembelian: Belum Dibayar')
...
<div class="content">
	<div class="page-inner">
		<div class="page-header">
			<h4 class="page-title">Data Pembelian: Belum Dibayar</h4>
				...
				<div class="card">
					<div class="card-header">
						<div class="d-flex align-items-center">
							<h4 class="card-title">Data Pembelian: Belum Dibayar</h4>
						</div>
					</div>
					<div class="card-body">
									...
									<tr>
										...
										<td>
											<div class="form-button-action">
												<a data-toggle="tooltip" title="" class="btn btn-link" data-original-title="User belum melakukan pembayaran." onclick="event.preventDefault();" disabled style="cursor: not-allowed;">
			...
			$.ajax({
				...
				success: function(response){
					if(response == "Berhasil menghapus data."){
						alert(response);
						window.location.href = '/admin/pembelian/belum-dibayar';
					}
					else{
						alert(response);
					}
