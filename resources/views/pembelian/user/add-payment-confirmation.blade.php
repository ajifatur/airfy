...
<!--         <div class="row">
        ...
        <form id="form" method="post" action="/pembelian/confirm/store" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="checkout-form-list">
                                    ...
                                    <input name="nama_rekening" type="text" class="{{ $errors->has('nama_rekening') ? 'border border-danger' : '' }}"/>
                            ...
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                                    ...
                                    <input name="jumlah_pembayaran" type="text" class="{{ $errors->has('jumlah_pembayaran') ? 'border border-danger' : '' }}"/>
                            ...
                            <div class="col-md-6">
                                <div class="checkout-form-list">
                                    ...
                                    <input name="tanggal_pembayaran" type="date" class="{{ $errors->has('tanggal_pembayaran') ? 'border border-danger' : '' }}"/>
                            ...
                            <div class="col-md-12">
                                <div class="checkout-form-list">
                                    ...
                                    <br>
                                    <img class="d-none img-thumbnail mt-3 bukti-gambar" width="300">
                                </div>
                            </div>
                            <div class="col-md-12">
