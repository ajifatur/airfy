							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group {{ $errors->has('nama_produk') ? 'has-error' : '' }}">
										...
										<input type="text" name="nama_produk" class="form-control" id="nama" placeholder="Masukkan Nama Produk" value="{{ old('nama_produk') }}">
									...
									<div class="form-group {{ $errors->has('harga') ? 'has-error' : '' }}">
										...
										<div class="input-group">
											...
											<input type="text" name="harga" class="form-control" id="harga" placeholder="Masukkan Harga" value="{{ number_format(old('harga'),0,',',',') }}" aria-label="harga" aria-describedby="basic-addon1">
										</div>
                    					@if($errors->has('harga'))
									...
									<div class="form-group {{ $errors->has('stok') ? 'has-error' : '' }}">
										...
										<div class="input-group">
											...
											<input type="text" name="stok" class="form-control" id="stok" placeholder="" value="1" aria-label="" aria-describedby="basic-addon2" style="text-align: center;">
									...
									<div class="form-group {{ $errors->has('berat') ? 'has-error' : '' }}">
										...
										<input type="number" name="berat" class="form-control" id="berat" placeholder="Masukkan Berat Produk" value="{{ old('berat') }}">
                    					@if($errors->has('berat'))
									...
									<div class="form-group {{ $errors->has('deskripsi_produk') ? 'has-error' : '' }}">
										...
										<textarea name="deskripsi_produk" class="form-control" id="deskripsi" placeholder="Masukkan Deskripsi Produk" rows="3">{{ old('deskripsi_produk') }}</textarea>
								...
								<div class="col-md-6">	
											...
											<div class="col">
												<div class="selectgroup selectgroup-pills">
													...
													<label class="selectgroup-item">
														<input type="checkbox" name="kategori[]" value="{{ $data->id_kategori }}" class="selectgroup-input">
									...
									<div class="form-group">
										...
										<div class="row mt-3 imagecheck-field"></div>
									</div>
								</div>
							</div>
						</div>
