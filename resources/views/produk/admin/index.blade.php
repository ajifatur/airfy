				...
				<div class="card">
					<div class="card-header">
						<div class="d-flex align-items-center">
							...
							<a class="btn btn-primary btn-round ml-auto" href="/admin/produk/tambah">
							...
							<table id="table" class="display table table-striped table-hover table-bordered">
								<thead>
									<tr>
										...
										<th style="width: 100px">Berat (gram)</th>
								...
								<tbody>
									...
									<tr>
										...
										<td>{{ number_format($data->berat,0,',',',') }}</td>
										<td>{{ number_format($data->stok,0,',',',') }}</td>
										<td>
											<div class="form-button-action">
												<a href="/admin/produk/edit/{{ $data->id_produk }}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
													<i class="fa fa-edit"></i>
												</a>
												<a href="#" data-id="{{ $data->id_produk }}" data-toggle="tooltip" title="" class="btn btn-link btn-danger btn-delete" data-original-title="Hapus">
