...
<div class="content">
	<div class="page-inner">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<form method="post" action="/admin/admin/update" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="form-group {{ $errors->has('no_telepon') ? 'has-error' : '' }}">
										...
										<input type="text" name="no_telepon" class="form-control" id="no_telepon" placeholder="Masukkan Nomor Telepon" value="{{ $admin->no_telepon }}">
												...
												<div class="col-md-6 col-12 imagecheck-div">
													<label class="imagecheck mb-4">
														...
														<figure class="imagecheck-figure">
															<img src="{{ asset('assets/images/admin/'.$admin->foto) }}" alt="title" class="imagecheck-image">
														</figure>
													</label>
												</div>
											@else
