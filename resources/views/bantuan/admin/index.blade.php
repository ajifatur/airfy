				...
				<div class="card">
					<div class="card-header">
						<div class="d-flex align-items-center">
							...
							<a class="btn btn-primary btn-round ml-auto" href="/admin/bantuan/tambah">
						...
						<div class="table-responsive">
							<table id="table" class="display table table-striped table-hover table-bordered">
								...
								<tbody>
									...
									<tr>
										<td>{{ $i }}</td>
										<td>{{ $data->judul_bantuan }}</td>
										<td>{{ $data->nama }}</td>
										<td>
											<div class="form-button-action">
												<a href="/admin/bantuan/edit/{{ $data->id_bantuan }}" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit">
													<i class="fa fa-edit"></i>
												</a>
												<a href="#" data-id="{{ $data->id_bantuan }}" data-toggle="tooltip" title="" class="btn btn-link btn-danger btn-delete" data-original-title="Hapus">
