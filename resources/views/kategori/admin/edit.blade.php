...
<div class="content">
	<div class="page-inner">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<form method="post" action="/admin/kategori/update">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group {{ $errors->has('nama_kategori') ? 'has-error' : '' }}">
										...
										<input type="text" name="nama_kategori" class="form-control" id="nama" placeholder="Masukkan Nama Kategori" value="{{ $kategori->nama_kategori }}">
